...
public class PretendDatabaseSecurityRepositoryImpl implements SecurityRepository{
    ...
    public PretendDatabaseSecurityRepositoryImpl() {
        ...
        System.out.println("====== Inside constructor of PretendDatabaseSecurityRepositoryImpl(), before setting, alarmStatus = " + alarmStatus);
        alarmStatus = AlarmStatus.NO_ALARM;
        System.out.println("====== Inside constructor of PretendDatabaseSecurityRepositoryImpl(), after setting, alarmStatus = " + alarmStatus);
